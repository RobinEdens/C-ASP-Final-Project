...
public partial class Doctor_Messaging_NewMessage : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if(IsPostBack && ValidateMessage())
        {
            ...
            {
                UserNameFrom = Session["GetName"].ToString(),
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            var recipient =
                from x in dbcontext.tblPatients.Local
                where x.PatientID.Equals(Convert.ToInt32(GridView1.SelectedDataKey.Value))
